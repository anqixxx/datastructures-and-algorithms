...
//   // cout << *(outimg.getPixel(0,1)) << endl;
//   // cout << *(outimg.getPixel(1,0)) << endl;
//   // cout << *(outimg.getPixel(1,1)) << endl;
//   // cout << "diff" << endl;
//   // cout << *(img.getPixel(0,0)) << endl;
//   // cout << *(img.getPixel(0,1)) << endl;
//   // cout << *(img.getPixel(1,0)) << endl;
//   // cout << *(img.getPixel(1,1)) << endl;
